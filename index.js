...
console.log(createMenuItem('pasta', 'Pasta', 6, "Dinner"))

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

console.log(createMenuItem('friedRice', 'Fried Rice', 9, "Lunch"))
console.log(createMenuItem('padThai', 'Pad Thai', 10, "Dinner"))
console.log(createMenuItem('panangCurry', 'Pasta', 10, "Dinner"))
...
reviews.push({name: "Austin", rating: 5, feedback:"Great energy"});
// console.log(reviews);
